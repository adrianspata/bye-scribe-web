...
export type SignalFieldVariant = 'path' | 'tool' | 'editorial' | 'summa';
...
export function SignalField({
  ...
  // Variant-specific gradient configurations (strictly cobalt, cyan, violet)
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 pointer-events-none select-none bg-repeat opacity-[var(--signal-grain-opacity)] mix-blend-overlay"
        style={{
